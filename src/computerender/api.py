...
class ApiError(ValueError):
    """Superclass for any exception generated by computerender API"""


class SafetyError(ApiError):
    """Exception corresponding to NSFW filters"""


class TermError(SafetyError):
    """Exception corresponding to pre-generation NSFW text filter"""


class ContentError(SafetyError):
    """Exception corresponding to post-generation NSFW image filter"""
